...
const securityFeatures = [
  {
    icon: Database,
    title: "Row-Level Security حقيقي",
    desc: "العزل يتم على مستوى قاعدة بيانات PostgreSQL، وليس مجرد فلترة في التطبيق. حتى لو حاول أحدهم الوصول مباشرة، لن يرى بيانات مشغل آخر.",
    code: "RLS ON workshops",
  },
  {
    icon: KeyRound,
    title: "SECURITY DEFINER محمي",
    desc: "كل صلاحيات الأدمن محمية بدوال PostgreSQL SECURITY DEFINER، مع فحص صريح للدور — وليست مجرد فحص بالواجهة يمكن تجاوزه.",
    code: "SECURITY DEFINER",
  },
  {
    icon: Server,
    title: "Triggers تدير الحساسة",
    desc: "الأعمدة الحرجة (العدادات، تواريخ الأرشفة، إصدار القالب) يديرها قاعدة البيانات تلقائيًا. التطبيق لا يكتب عليها مباشرة أبدًا.",
    code: "BEFORE INSERT/UPDATE",
  },
  {
    icon: FileLock2,
    title: "أرشفة بدل الحذف",
    desc: "الأنظمة والقوالب تُؤرشف بدل الحذف النهائي. الحذف الوحيد يكون بعد ١٤ يومًا من التعليق، وبترتيب صريح مضبوط مع الاحتفاظ بسجل دائم.",
    code: "archive_at + version",
  },
];
          ...
          <div className="order-1 lg:order-2">
            <Reveal>
              ...
              <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foreground mb-6">
                ...
                <span className="text-gradient-brand">عزلًا حقيقيًا</span>
              </h2>
              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-8">
                نأخذ خصوصية بياناتك على محمل الجد. العزل بين المشاغل يتم على مستوى
                قاعدة البيانات — وليس مجرد فلترة يمكن تجاوزها. بياناتك لك وحدك،
                ولا يمكن لأي مشغل آخر الوصول إليها بأي طريقة.
              </p>
            </Reveal>
