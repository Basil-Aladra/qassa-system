  ...
  return (
    <section id="contact" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-700 via-brand-800 to-emerald-900" />
        <div className="absolute inset-0 bg-grid-pattern opacity-20" />
        {/* Glows */}
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-gold-400/20 rounded-full blur-[120px]" />
      ...
      <div className="container mx-auto max-w-5xl px-4 sm:px-6 relative">
        <Reveal className="text-center">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
            جاهز تحوّل مشغل الألمنيوم
            <br className="hidden sm:block" /> إلى{" "}
            <span className="text-gradient-gold">نظام ذكي</span>؟
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {[
              { icon: Phone, label: "اتصل بنا", value: "0599-XXX-XXX" },
              {
                icon: MessageCircle,
                label: "واتساب",
                value: "0599-XXX-XXX",
              ...
              <motion.div
                ...
                className="flex items-center gap-3 justify-center sm:justify-start p-4 rounded-2xl bg-white/5 backdrop-blur border border-white/10"
              >
                <div className="grid place-items-center w-10 h-10 rounded-xl bg-white/10 text-gold-300 flex-shrink-0">
